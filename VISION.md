...
|---|---|---|
| `/` | Both | Hero — origin story, mission statement, quick stats |
...
| `/links` | Both | All community links in one place |
...
- Should the site be static (GitHub Pages) or need a backend for the leaderboard/tracker?
